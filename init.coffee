...
insertItems = ->
	...
	prototypes = [
		...
		[ 17, 'Тяжелый тесак', 'weapon-one-handed', 'short', 'sword', 450, null, 80 ]
		[ 18, 'Шипованная дубина', 'weapon-one-handed', 'normal', 'sword', 350, null, 90 ]
		[ 19, 'Посох шамана', 'weapon-two-handed', 'normal', 'sword', 350, null, 35 ]
		[ 20, 'Деревянный посох', 'weapon-two-handed', 'normal', 'sword', 300, null, 25 ]
		...
		[ 23, 'Деревянная дубина', 'weapon-two-handed', 'normal', 'sword', 200, null, 105 ]
	...
	for proto in prototypes
		query(
			'INSERT INTO items_proto (id, name, type, class, kind, strength_max, coverage, damage) '+
			'VALUES ($1, $2, $3, $4, $5, $6, $7, $8)', proto)
	console.log chalk.green 'ok'
	...
	for user in users
		...
		for item in prototypes
			query 'INSERT INTO items (prototype, owner, strength, equipped) '+
				'VALUES ($1, $2, $3, false)', [item[0], user.character_id, item[5]]
		console.log chalk.green 'ok'
