...
insertItems = ->
	...
	prototypes = [
		...
		[ 1, 'Железный шлем драконопоклонника', 'hat', null, 280, 10, null ]
		[ 2, 'Стальной шлем драконопоклонника', 'hat', null, 340, 10, null ]
		[ 3, 'Закрытый стальной шлем', 'hat', null, 500, 13, null ]
		[ 4, 'Стальной гладиаторский шлем', 'hat', null, 505, 13, null ]
		[ 5, 'Гладиаторский шлем из дюрали', 'hat', null, 580, 13, null ]
		[ 6, 'Железный топхелм', 'hat', null, 320, 12, null ]
		[ 7, 'Простой рогатый шлем', 'hat', null, 200, 6, null ]
		[ 8, 'Шипованный правый наплечник', 'pouldron-right', null, 480, 8, null ]
		[ 27, 'Железный правый наплечник', 'pouldron-right', null, 300, 10, null ]
		...
		[ 13, 'Короткий эльфийский меч', 'weapon-one-handed', 'normal', 500, null, 70 ]
		...
		[ 17, 'Тяжелый тесак', 'weapon-one-handed', 'short', 450, null, 80 ]
		...
		[ 25, 'Коготь смерти', 'weapon-one-handed', 'normal', 705, null, 140 ]
