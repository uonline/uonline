...
if ($_POST) {
    if (correctUserName($_POST['user']) && correctMail($_POST['mail']) && correctAdminPassword($_POST['pass']) && $_POST['ad_pass'] == ADMIN_PASS) {
       ...
       echo incorrectDatas( array( correctUserName($_POST['user']), correctMail($_POST['mail']), correctAdminPassword($_POST['pass']) ) );
