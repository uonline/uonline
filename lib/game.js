...
exports.getDefaultLocation = function(dbConnection, callback) {
	dbConnection.query(
		...
		function (error, result) {
			...
			{
				error = new Error('default location is not defined');
			}
			if (!!result && result.rowCount > 1)
			{
				error = new Error('there is more than one default location');
			}
...
exports.changeLocation = function(dbConnection, userid, locid, callback) {
	...
	exports.getUserLocation(dbConnection, userid, function(error, result) {
		...
		tx.query('UPDATE uniusers SET location = $1 WHERE id = $2', [locid, userid]);
		tx.query(
			'UPDATE uniusers '+
