...
// Stops battle. Sets autoinvolved_fm to 0 for all unvolved users,
...
// Deals damage damage to opponent is user's battle.
// Opponent is determined by his 'index' among all participants of user's battle.
exports.hitOpponent = function(dbConnection, userid, participantIndex) {
	...
	if (health <= 0)
	{
		exports._leaveBattle(dbConnection, user.battle, targetParticipant.id, targetParticipant.kind);
