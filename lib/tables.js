...
exports.changeCol = function(dbConnection, table, colName, colAttrs, callback) {
	dbConnection.query(
		'ALTER TABLE '+table+' ALTER COLUMN '+colName+' TYPE '+colAttrs,
		[], callback);
};

exports.changeDefault = function(dbConnection, table, colName, value, callback) {
	dbConnection.query(
		'ALTER TABLE '+table+' ALTER COLUMN '+colName+' SET DEFAULT '+value,
		[], callback);
};
...
exports.createIndex = function(dbConnection, table, column, callback) {
	dbConnection.query(
...
exports.createEnum = function(dbConnection, enumName, values, callback) {
	dbConnection.query(
